...
***************************************************************/
void fndStudentAverage (int const scores [ ][3],double stdAver [ ], int rowSize, int colSize){
...
***************************************************************/
void fndTestAverage (int const scores [][3],
...
int main(){
	...
	for (int i = 0; i < rowSize ; i++){
		...
		cout << fxed << setprecision (2) << " " << stdAver[i] << endl;
	}
	// Print test averages
	cout << "tstAver ";
	cout << "--------------------------- ";
	for (int j = 0 ; j < colSize; j++){
		cout << fxed << setprecision (2) << stdAver[j] << " ";
	}
	return 0;
}